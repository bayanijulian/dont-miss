...
public class MenuScreen implements Screen{
	...
	private static Button playBtn, optionsBtn, rightArrowBtn, leftArrowBtn, oneBtn, twoBtn, threeBtn, backBtnOptions, backBtnAchievements, backBtnPlay, backBtnAbout, backBtnScores, backBtnStore, scoresBtn, aboutBtn, achievementsBtn, storeBtn;
	...
	private void createButtons() {
		...
		achievementsBtn.setSize(achievementsBtn.getWidth()*scaleX, achievementsBtn.getHeight()*scaleY);
...
//		aboutMenu.addActor(aboutMenuBG);
	...
	private void groupAchievementsMenu() {
